...
} elseif ($_instance->childHasBeenRendered('l2939099485-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2939099485-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2939099485-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2939099485-0');
} else {
    $response = \Livewire\Livewire::mount('frontend.customer-logout');
    $html = $response->html();
    $_instance->logRenderedChild('l2939099485-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php else: ?>
