        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-between bg-light rounded px-3 py-2 mb-3 text-muted small">
                    ...
                    <div>
                        <span>Current Page: <strong><?php echo e($option_groups->currentPage()); ?></strong></span>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered align-middle mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $option_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($key + $option_groups->firstItem()); ?></td>
                                    <td class="fw-semibold text-dark"><?php echo e(str_replace('_', ' ', $val->option_group_name)); ?></td>
                                    <td>
            ...
            <div class="card-footer bg-white border-top py-3">
                <div class="row align-items-center g-3">
                    ...
                    <div class="col-md-6 text-md-end text-muted small">
                        <p class="mb-0">
                            <?php echo e(__('Showing')); ?> <span class="fw-semibold text-dark"><?php echo e($option_groups->firstItem()); ?></span>
                            <?php echo e(__('to')); ?> <span class="fw-semibold text-dark"><?php echo e($option_groups->lastItem()); ?></span>
                            <?php echo e(__('of')); ?> <span class="fw-semibold text-dark"><?php echo e($option_groups->total()); ?></span> <?php echo e(__('results')); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\laragon\www\laravel\ecom\resources\views/livewire/backend/option-group/index.blade.php ENDPATH**/ ?>