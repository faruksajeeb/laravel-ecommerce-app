    ...
    <section class="section-padding">
        <div class="container pt-25">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img src="<?php echo e(asset('frontend-assets/imgs/page/about-1.png')); ?>" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center">
                    ...
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted"
                                src="<?php echo e(asset('frontend-assets/imgs/page/avatar-1.jpg')); ?>" alt="">
                        </div>
                        <div class="pl-30">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted"
                                src="<?php echo e(asset('frontend-assets/imgs/page/avatar-3.jpg')); ?>" alt="">
                        </div>
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                B.Gates
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted"
                                src="<?php echo e(asset('frontend-assets/imgs/page/avatar-2.jpg')); ?>" alt="">
                        </div>
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                B. Meyers
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted"
                                src="<?php echo e(asset('frontend-assets/imgs/page/avatar-4.jpg')); ?>" alt="">
                        </div>
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                J. Bezos
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted"
                                src="<?php echo e(asset('frontend-assets/imgs/page/avatar-5.jpg')); ?>" alt="">
                        </div>
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                B.Gates
...
<?php /**PATH C:\xampp8.1.6\htdocs\laravel-ecommerce-app\resources\views/livewire/frontend/about.blade.php ENDPATH**/ ?>