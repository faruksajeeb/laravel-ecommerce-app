                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    <div class="main-categori-wrap mobile-header-border">
                        ...
                        <div class="categori-dropdown-wrap categori-dropdown-active-small">
                            <ul>
                                <li><a href="shop.html"><i class="sajeeb-font-dress"></i>Women's Clothing</a>
                                </li>
                                <li><a href="shop.html"><i class="sajeeb-font-tshirt"></i>Men's Clothing</a>
                                </li>
                                <li> <a href="shop.html"><i class="sajeeb-font-smartphone"></i> Cellphones</a>
                                </li>
                                <li><a href="shop.html"><i class="sajeeb-font-desktop"></i>Computer &
                                        Office</a></li>
                                <li><a href="shop.html"><i class="sajeeb-font-cpu"></i>Consumer Electronics</a>
                                </li>
                                <li><a href="shop.html"><i class="sajeeb-font-home"></i>Home & Garden</a></li>
                                <li><a href="shop.html"><i class="sajeeb-font-high-heels"></i>Shoes</a></li>
                                <li><a href="shop.html"><i class="sajeeb-font-teddy-bear"></i>Mother & Kids</a>
                                </li>
                                <li><a href="shop.html"><i class="sajeeb-font-kite"></i>Outdoor fun</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- mobile menu start -->
