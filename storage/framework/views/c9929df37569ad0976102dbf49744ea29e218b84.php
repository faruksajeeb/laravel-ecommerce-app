                            ...
                            <tbody>
                                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-danger" wire:click.prevent="downloadOrderInvoice('<?php echo e(Crypt::encryptString($val->id)); ?>')"><i class="fa-solid fa-file-arrow-down"></i> invoice</button>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\laragon\www\laravel\ecom\resources\views/livewire/backend/order/index.blade.php ENDPATH**/ ?>