...
} elseif ($_instance->childHasBeenRendered('l1988016686-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1988016686-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1988016686-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1988016686-0');
} else {
    $response = \Livewire\Livewire::mount('frontend.filter-by-category', ['route' => Route::currentRouteName()]);
    $html = $response->html();
    $_instance->logRenderedChild('l1988016686-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <!-- Fillter By Price -->
...
} elseif ($_instance->childHasBeenRendered('l1988016686-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1988016686-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1988016686-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1988016686-1');
} else {
    $response = \Livewire\Livewire::mount('frontend.filter-by-price');
    $html = $response->html();
    $_instance->logRenderedChild('l1988016686-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    ...
                    <div class="shop-product-fillter">
                        <div class="totall-product">
                            <p> We found <strong class="text-brand"><?php echo e($products->total()); ?></strong> items for you!
                                <?php echo e($categoryName || $subcategoryName ? 'from ' : ''); ?><strong
                                    class="text-brand"><?php echo e($categoryId ? $categoryName : ($subcategoryId ? $subcategoryName : '')); ?></strong>
                                <?php echo e($categoryName ? 'category ' : ($subcategoryName ? 'subcategory' : '')); ?></p>
                        </div>
                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        ...
                                        <div class="product-badges product-badges-position product-badges-mrg">
                                            <span class="hot"><?php echo e($product->category?->name ?? 'Hot'); ?></span>
                                        </div>
                                    </div>
...
<?php /**PATH D:\laragon\www\laravel\ecom\resources\views/livewire/frontend/shop.blade.php ENDPATH**/ ?>