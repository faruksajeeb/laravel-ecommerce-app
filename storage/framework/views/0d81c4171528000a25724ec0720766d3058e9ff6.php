                            ...
                            <div class="product-cart-wrap mb-xs-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-5-1.jpg')); ?>"
                                                alt="">
                                            <img class="hover-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-5-2.jpg')); ?>"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-xs-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-6-1.jpg')); ?>"
                                                alt="">
                                            <img class="hover-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-6-2.jpg')); ?>"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-8-1.jpg')); ?>"
                                                alt="">
                                            <img class="hover-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-8-2.jpg')); ?>"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-10-1.jpg')); ?>"
                                                alt="">
                                            <img class="hover-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-10-2.jpg')); ?>"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-11-1.jpg')); ?>"
                                                alt="">
                                            <img class="hover-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-11-2.jpg')); ?>"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-12-1.jpg')); ?>"
                                                alt="">
                                            <img class="hover-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-12-2.jpg')); ?>"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-13-1.jpg')); ?>"
                                                alt="">
                                            <img class="hover-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-13-2.jpg')); ?>"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-14-1.jpg')); ?>"
                                                alt="">
                                            <img class="hover-img"
                                                src="<?php echo e(asset('frontend-assets/imgs/shop/product-14-2.jpg')); ?>"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
