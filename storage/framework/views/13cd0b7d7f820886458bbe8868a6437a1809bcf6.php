                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input name="newImage" id="product_image" wire:model="newImage"
                                    class="form-control image <?php $__errorArgs = ['newImage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="file">
                                ...
                                <?php elseif($oldImage): ?>
                                    <img src="<?php echo e(asset('frontend-assets/imgs/products/' . $oldImage)); ?>"
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\laragon\www\laravel\ecom\resources\views/livewire/backend/product/edit.blade.php ENDPATH**/ ?>