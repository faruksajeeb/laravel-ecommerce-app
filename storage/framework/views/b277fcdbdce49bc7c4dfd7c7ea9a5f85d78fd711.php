                            ...
                            <tbody>
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><img src="<?php echo e(asset('frontend-assets/imgs/categories')); ?>/<?php echo e($val->image); ?>" width="50" /></td>
                                        <td><?php echo e($val->name); ?></td>
                                        <td><?php echo e(str_replace('_', ' ', $val->slug)); ?></td>
                                        <td><?php echo e($val->is_popular==1 ? 'Yes':'No'); ?></td>
                                        <td>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\laragon\www\laravel\ecom\resources\views/livewire/backend/category/index.blade.php ENDPATH**/ ?>