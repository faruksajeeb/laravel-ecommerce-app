    ...
    <section>
        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body py-1">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                Current Page <?php echo e($sliders->currentPage()); ?>
                        ...
                        <table class="table table-striped table-brodered table-sm">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($key + $sliders->firstItem()); ?></td>
                                        <td><?php echo e($val->top_title); ?></td>
                                        <td><?php echo e($val->title); ?></td>
                                        <td><?php echo e($val->sub_title); ?></td>
                                        <td><?php echo e($val->offer); ?></td>
                                        ...
                                        ?>
                                        <td><img src="<?php echo e(asset('frontend-assets/imgs/sliders')); ?>/<?php echo e($file); ?>" width="80" height="80" alt="<?php echo e($val->name); ?>"></td>
                                        ...
                                        <td>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input active_inactive_btn "
                                                    ...
                                                    table="sliders" type="checkbox" id="row_<?php echo e($val->id); ?>"
                            ...
                            <div class="col-md-6 text-end">
                                <div>
                                    <p class="text-sm text-gray-700 leading-5">
                                        ...
                                        <span class="font-medium"><?php echo e($sliders->firstItem()); ?></span>
                                        <?php echo __('to'); ?>

                                        <span class="font-medium"><?php echo e($sliders->lastItem()); ?></span>
                                        <?php echo __('of'); ?>

                                        <span class="font-medium"><?php echo e($sliders->total()); ?></span>
                                        <?php echo __('results'); ?>
                ...
                <?php echo $__env->make('livewire.backend.slider.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->make('livewire.backend.slider.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </section>
</div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp8.1.6\htdocs\laravel-ecommerce-app\resources\views/livewire/backend/slider/index.blade.php ENDPATH**/ ?>