                        ...
                        <div class="col-md-4">
                            <div class="dashboard-menu">
                                <ul class="nav flex-column" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#" wire:click.prevent='customerLogout'><i
                                ...
                                <div class="tab-pane fade active show" id="dashboard" role="tabpanel"
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="mb-0">Hello
                                                <?php echo e(ucwords(Auth::guard('customer')->user()->name)); ?>! </h5>
                                        </div>
                                        <div class="card-body">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $my_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $my_order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td>#<?php echo e($my_order->id); ?></td>
                                                                <td><?php echo e($my_order->created_at); ?></td>
                                                                <td><?php echo e($my_order->status); ?></td>
                                                                <td><?php echo e($my_order->total); ?> for <?php echo e($my_order->quantity); ?> item</td>
...
<?php /**PATH C:\xampp8.1.6\htdocs\laravel-ecommerce-app\resources\views/livewire/frontend/my-account-component.blade.php ENDPATH**/ ?>