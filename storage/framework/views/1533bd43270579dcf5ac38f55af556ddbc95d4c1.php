...
} elseif ($_instance->childHasBeenRendered('NoIp4bw')) {
    $componentId = $_instance->getRenderedChildComponentId('NoIp4bw');
    $componentTag = $_instance->getRenderedChildComponentTagName('NoIp4bw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NoIp4bw');
} else {
    $response = \Livewire\Livewire::mount('frontend.news-letter-component');
    $html = $response->html();
    $_instance->logRenderedChild('NoIp4bw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
