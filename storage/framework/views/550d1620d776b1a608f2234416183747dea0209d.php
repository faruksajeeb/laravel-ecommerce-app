            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header bg-white my-0 pt-2 pb-0">
                        <div class="row ">
                            <div class="col-md-8">
                                <h4 class="card-title py-1"><i class="fa fa-list"></i> Subcategories</h4>
                    ...
                    <div class="card-body py-1">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                Current Page <?php echo e($subcategories->currentPage()); ?>
                        ...
                        <table class="table table-striped table-brodered table-sm">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input active_inactive_btn "
                                                    ...
                                                    table="subcategories" type="checkbox" id="row_<?php echo e($val->id); ?>"
                    ...
                    <div class="card-footer " wire:key="$subcategories->id">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6 text-end">
                                <div>
                                    <p class="text-sm text-gray-700 leading-5">
                                        ...
                                        <span class="font-medium"><?php echo e($subcategories->firstItem()); ?></span>
                                        <?php echo __('to'); ?>

                                        <span class="font-medium"><?php echo e($subcategories->lastItem()); ?></span>
                                        <?php echo __('of'); ?>

                                        <span class="font-medium"><?php echo e($subcategories->total()); ?></span>
                                        <?php echo __('results'); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp8.1.6\htdocs\laravel-ecommerce-app\resources\views/livewire/backend/subcategory/index.blade.php ENDPATH**/ ?>