<div>
    ...
    <section class="mt-50 mb-50">
        <div class="container">
            ...
            <?php endif; ?>
            <form method="post" wire:submit.prevent='placeOrder' class="needs-validation" novalidate>
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-25">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <input type="text" name="billing_address" wire:model='line1' placeholder="Address *"
                                class="<?php $__errorArgs = ['line1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="ship_detail">
                            <div class="form-group">
                                <div class="chek-form">
                                    <div class="custome-checkbox">
                                        <input class="form-check-input" type="checkbox" name="differentaddress"
                                            id="differentaddress" wire:model='differentaddress'>
                                        <label class="form-check-label label_info" data-bs-toggle=""
                            ...
                            <?php if($differentaddress): ?>
                                <div id="collapseAddress" class="different_address  in">
                                    <div class="form-group">
                                        <input type="text" required="" name="s_first_name"
                                            wire:model='s_first_name' placeholder="First name *"
                                            class=" <?php $__errorArgs = ['s_first_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <input type="text" required="" name="s_last_name"
                                            wire:model='s_last_name' placeholder="Last name *"
                                            class=" <?php $__errorArgs = ['s_last_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <input required="" type="text" name="s_mobile" wire:model='s_mobile'
                                            placeholder="Mobile" class=" <?php $__errorArgs = ['s_mobile'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="custom_select">
                                            <select class="form-control select-active" name='s_country'
                                    ...
                                    <div class="form-group">
                                        <input required="" type="text" name="s_city" wire:model=''
                                    ...
                                    <div class="form-group">
                                        <input required="" type="text" name="s_zip_code"
                                            wire:model='s_zip_code' placeholder="Postcode / ZIP *">
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                                            ...
                                            <?php $__currentLoopData = Cart::instance('cart')->content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td class="image product-thumbnail"><img
                                                            ...
                                                            alt="#"></td>
                                                    <td>
                                                        <h5><a href="product-details.html"><?php echo e($item->name); ?></a>
                                                        </h5>
                            ...
                            <div class="payment_method">
                                ...
                                <div class="">
                                    <div class="custome-radio">
                                        <input class="form-check-input <?php $__errorArgs = ['payment_mode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            type="radio" name="payment_mode" id="exampleRadios3" value='cod'
...
unset($__errorArgs, $__bag); ?>"
                                            type="radio" name="payment_mode" id="exampleRadios4" value='card'
                                            wire:model='payment_mode'>
...
unset($__errorArgs, $__bag); ?>"
                                            type="radio" name="payment_mode" id="exampleRadios5" value='paypal'
                                            wire:model='payment_mode'>
...
unset($__errorArgs, $__bag); ?>"
                                                name="card_number" wire:model='card_number'
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <input type="text"
                                                class="form-control <?php $__errorArgs = ['expiry_month'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid                                   
...
unset($__errorArgs, $__bag); ?>"
                                                name="expiry_month" wire:model='expiry_month'
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <input type="text"
                                                class="form-control <?php $__errorArgs = ['expiry_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid                                   
...
unset($__errorArgs, $__bag); ?>"
                                                name="expiry_year" wire:model='expiry_year'
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <input type="password"
                                                class="form-control <?php $__errorArgs = ['cvc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid                                   
...
unset($__errorArgs, $__bag); ?>"
                                                name="cvc" wire:model='cvc' placeholder="CVC *">
                                            <?php $__errorArgs = ['cvc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH C:\xampp8.1.6\htdocs\laravel-ecommerce-app\resources\views/livewire/frontend/checkout.blade.php ENDPATH**/ ?>