<div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
    ...
    <?php $__currentLoopData = $new_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="single-post clearfix">
            <div class="image">
                <img src="<?php echo e(asset('frontend-assets/imgs/shop/thumbnail-')); ?><?php echo e($new_product->id); ?>.jpg" alt="#">
            </div>
...
<?php /**PATH C:\xampp8.1.6\htdocs\laravel-ecommerce-app\resources\views/livewire/frontend/new-products.blade.php ENDPATH**/ ?>