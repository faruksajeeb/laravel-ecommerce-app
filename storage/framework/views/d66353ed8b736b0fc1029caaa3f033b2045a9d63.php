                                    ...
                                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><i class="fa-solid fa-mobile-retro"></i>
                                                <?php echo e($order->mobile); ?></td>
                                            <td class="text-center"><i class="fa-solid fa-envelope"></i> <?php echo e($order->email); ?>

                                            </td>
                                            <td class="text-end"><i class="fa-solid fa-bangladeshi-taka-sign"></i>
                                                <?php echo e($order->total); ?></td>
                                            <td class="text-center"><i class="fa-solid fa-calander"></i>
                                                <?php echo e($order->created_at); ?></td>
                                            <td class="text-center"><i class="fa-solid fa-calander"></i>
                                                <?php echo App\Lib\Webspice::textStatus($order->status); ?></td>
                                        </tr>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\laravel\ecom\resources\views\dashboard.blade.php ENDPATH**/ ?>