<div>
    <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
        ...
        <?php $__currentLoopData = $new_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $featureImage = $new_product->image ?: 'product-image-avatar.png';
            ?>
            <div class="single-post clearfix">
                <div class="image">
                    <img src="<?php echo e(asset('frontend-assets/imgs/products')); ?>/<?php echo e($featureImage); ?>"
...
<?php /**PATH D:\laragon\www\laravel\ecom\resources\views/livewire/frontend/new-products-component.blade.php ENDPATH**/ ?>