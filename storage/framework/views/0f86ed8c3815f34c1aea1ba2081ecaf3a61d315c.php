        ...
        <section>
            ...
            <div class="row">
                <div class="col-md-12">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($val->present_address); ?></td>
                                            <td><?php echo e($val->permenent_address); ?></td>
                                            <td><?php echo e($val->shipping_address); ?></td>
                                            <td>
                    ...
                    <?php echo $__env->make('livewire.backend.customer.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php echo $__env->make('livewire.backend.customer.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </section>
    </div>
