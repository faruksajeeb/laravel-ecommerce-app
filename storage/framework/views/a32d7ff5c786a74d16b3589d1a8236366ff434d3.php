...
<?php $component->withAttributes([]); ?>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 pb-3 border-bottom">
        <div class="mb-3 mb-md-0">
            <h4 class="text-dark fw-bold mb-1">
                <i class="fa fa-pencil-alt text-primary me-2"></i>Edit Role — <span class="text-secondary fw-semibold"><?php echo e(ucwords($roleInfo->name)); ?></span>
            </h4>
    ...
    <form action="<?php echo e(route('roles.update', Crypt::encryptString($roleInfo->id))); ?>" method="POST" id="roleEditForm">
        ...
        <div class="row g-4">
            <div class="col-lg-4">
                <div class="card border border-light-subtle shadow-sm rounded-4 p-4 sticky-lg-top" style="top: 1.5rem; z-index: 10;">
                    ...
                    <div class="mb-4">
                        <label for="role_name" class="form-label fw-semibold text-secondary small <?php if($errors->has('name')): ?> text-danger <?php endif; ?>">ROLE NAME</label>
                        <input type="text" name="name" id="role_name" 
                               value="<?php echo e(old('name', $roleInfo->name)); ?>" 
                               class="form-control form-control-lg border-2 shadow-none fs-6 px-3 <?php $__errorArgs = ['name'];
                            ...
                            <div class="row g-0 border-bottom border-light-subtle align-items-start permission-group-row">
                                ...
                                <div class="col-md-4 bg-light bg-opacity-25 p-4 border-end border-light-subtle h-100">
                                    <div class="form-check form-switch group-permission-switch" data-group="<?php echo e($permission_group->group_name); ?>">
                                        <input type="checkbox" name="group-permission[]" id="group_<?php echo e($groupIndex); ?>" 
                                            ...
                                            <div class="col-sm-6">
                                                <div class="p-2.5 px-3 border border-transparent rounded-3 hover-bg duration-150">
                                                    <div class="form-check single-permission-box" 
                                                        ...
                                                        <input type="checkbox" value="<?php echo e($permission->name); ?>" name="permissions[]" 
...
<?php endif; ?><?php /**PATH D:\laragon\www\laravel\ecom\resources\views\roles\edit.blade.php ENDPATH**/ ?>