    ...
    <div class="navigation bg-white">
                            ...
                            <span class="title">
                                <h5 class="py-2 d-inline-flex align-items-center gap-2 m-0">
                                    ...
                                    <span class="fw-bold text-dark tracking-tight fs-4">
                                        <?php echo e(substr(env('APP_NAME'), 1)); ?>
        ...
        <div class="side-menu h-100 ">
            <ul class="p-0 mb-3" id="menu">
                ...
                <li class="<?php echo e(Route::is('orders') ? 'active' : ''); ?>">
                    <a  href="<?php echo e(route('orders')); ?>" class="nav-link ps-1 align-middle">
                ...
                <?php if(Auth::guard('web')->user()->can('user.view') ||
                    ...
                    <li>
                        <a href="#user_submenu1"
                           ...
                           aria-expanded="<?php echo e(Route::is('users.index') || Route::is('users.create') || Route::is('roles.index') || Route::is('roles.create') ? 'true' : 'false'); ?>"
                           class="nav-link ps-1 align-middle">
                            <span class="icon"><i class="fa-solid fa-users"></i></span>
                ...
                <li>
                    <a href="#submenu1"
                       ...
                       aria-expanded="<?php echo e(Route::is('company-setting') || Route::is('basic-setting') || Route::is('email-setting') || Route::is('theme-setting') || Route::is('invoice-setting') || Route::is('approval-setting') || Route::is('salary-setting') || Route::is('notification-setting') || Route::is('toxbox-setting') || Route::is('cron-setting') ? 'true' : 'false'); ?>"
                       class="nav-link ps-1 align-middle">
