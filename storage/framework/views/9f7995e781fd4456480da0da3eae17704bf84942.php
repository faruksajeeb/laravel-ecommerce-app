...
<div>
    <section class="container-fluid py-4">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-between bg-light rounded px-3 py-2 mb-3 text-muted small">
                    ...
                    <div>
                        <span>Current Page: <strong><?php echo e($subcategories->currentPage()); ?></strong></span>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered align-middle mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($key + $subcategories->firstItem()); ?></td>
                                    <td class="text-muted small fw-semibold"><?php echo e(str_replace('_', ' ', $val->category->name ?? '')); ?></td>
                                    <td class="fw-semibold text-dark"><?php echo e(str_replace('_', ' ', $val->subcategory_name)); ?></td>
                                    <td>
            ...
            <div class="card-footer bg-white border-top py-3">
                <div class="row align-items-center g-3">
                    ...
                    <div class="col-md-6 text-md-end text-muted small">
                        <p class="mb-0">
                            <?php echo e(__('Showing')); ?> <span class="fw-semibold text-dark"><?php echo e($subcategories->firstItem()); ?></span>
                            <?php echo e(__('to')); ?> <span class="fw-semibold text-dark"><?php echo e($subcategories->lastItem()); ?></span>
                            <?php echo e(__('of')); ?> <span class="fw-semibold text-dark"><?php echo e($subcategories->total()); ?></span> <?php echo e(__('results')); ?>
        ...
        <?php echo $__env->make('livewire.backend.subcategory.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('livewire.backend.subcategory.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </section>
</div>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\laragon\www\laravel\ecom\resources\views\livewire\backend\subcategory\index.blade.php ENDPATH**/ ?>