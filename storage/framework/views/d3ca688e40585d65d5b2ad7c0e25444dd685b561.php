                            ...
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="<?php echo e(route('product-details', ['productId' => $item->model->id])); ?>">
                                        <img class="default-img"
                                            src="<?php echo e(asset('frontend-assets/imgs/products')); ?>/<?php echo e($wishImage); ?>"
                                            alt="">
                                        <img class="hover-img"
                                            src="<?php echo e(asset('frontend-assets/imgs/products')); ?>/<?php echo e($wishImage); ?>"
                                            alt="">
                                ...
                                <div class="product-action-1">
                                    ...
                                    <a aria-label="Compare" class="action-btn hover-up" href="#"
                                        wire:click.prevent='addToCompare(<?php echo e($item->model->id); ?>,"<?php echo e($item->model->name); ?>",<?php echo e($item->model->sale_price); ?>,"<?php echo e($item->options->image); ?>")'><i
...
<?php /**PATH D:\laragon\www\laravel\ecom\resources\views\livewire\frontend\wishlist-component.blade.php ENDPATH**/ ?>