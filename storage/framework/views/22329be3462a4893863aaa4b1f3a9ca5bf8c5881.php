...
} elseif ($_instance->childHasBeenRendered('yomhcYd')) {
    $componentId = $_instance->getRenderedChildComponentId('yomhcYd');
    $componentTag = $_instance->getRenderedChildComponentTagName('yomhcYd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yomhcYd');
} else {
    $response = \Livewire\Livewire::mount('frontend.my-order-detail-component');
    $html = $response->html();
    $_instance->logRenderedChild('yomhcYd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\laragon\www\laravel\ecom\resources\views\livewire\frontend\my-order-component.blade.php ENDPATH**/ ?>