                            ...
                            <tbody>
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td width="30%">
                                            <div class="accordion accordion-flush" id="permission-accordion-<?php echo e($val->id); ?>">
                                                <div class="accordion-item border-0">
                                                    <h2 class="accordion-header">
                                                        <button class="accordion-button collapsed p-0 shadow-none bg-transparent text-start"
                                                            type="button"
                                                            data-bs-toggle="collapse"
                                                            data-bs-target="#permission-panel-<?php echo e($val->id); ?>"
                                                            aria-expanded="false"
                                                            aria-controls="permission-panel-<?php echo e($val->id); ?>">
                                                            <span class="fw-semibold">View permissions</span>
                                                        </button>
                                                    </h2>
                                                    <div id="permission-panel-<?php echo e($val->id); ?>"
                                                        class="accordion-collapse collapse"
                                                        data-bs-parent="#permission-accordion-<?php echo e($val->id); ?>">
                                                        <div class="accordion-body px-0 py-2">
                                                            ...
                                                            <?php if(count($val->permissions) > 0): ?>
                                                                ...
                                                                <?php $__currentLoopData = $val->permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <span class="badge bg-info text-dark mb-1"><?php echo e($permission->name); ?></span>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            <?php else: ?>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\laravel\ecom\resources\views\users\index.blade.php ENDPATH**/ ?>