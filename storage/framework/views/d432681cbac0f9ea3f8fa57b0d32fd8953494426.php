...
} elseif ($_instance->childHasBeenRendered('uXuMcyk')) {
    $componentId = $_instance->getRenderedChildComponentId('uXuMcyk');
    $componentTag = $_instance->getRenderedChildComponentTagName('uXuMcyk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uXuMcyk');
} else {
    $response = \Livewire\Livewire::mount('frontend.filter-by-category', ['route' => Route::currentRouteName()]);
    $html = $response->html();
    $_instance->logRenderedChild('uXuMcyk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <!-- Fillter By Price -->
...
} elseif ($_instance->childHasBeenRendered('zozql96')) {
    $componentId = $_instance->getRenderedChildComponentId('zozql96');
    $componentTag = $_instance->getRenderedChildComponentTagName('zozql96');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zozql96');
} else {
    $response = \Livewire\Livewire::mount('frontend.filter-by-price');
    $html = $response->html();
    $_instance->logRenderedChild('zozql96', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
