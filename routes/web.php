...
use App\Http\Livewire\Frontend\SearchByCategoryComponent;
use App\Http\Livewire\Frontend\SearchBySubcategoryComponent;
...
#search-by-category
Route::get('/search-by-category/{categoryId}', SearchByCategoryComponent::class)->name('search-by-category');

#search-by-subcategory
Route::get('/search-by-subcategory/{subcategoryId}', SearchBySubcategoryComponent::class)->name('search-by-subcategory');
...
Route::get('/privacy-policy', function () {
    return ['privacy-policy' => 'This is the privacy policy page content.'
    ];
})->name('privacy-policy');
#terms-n-conditions
Route::get('/terms-n-conditions', function () {
    return ['terms-n-conditions' => 'This is the terms and conditions page content.'
    ];
