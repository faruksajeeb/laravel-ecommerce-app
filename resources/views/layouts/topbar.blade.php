<div class="topbar sticky-top bg-white border-b shadow-sm py-2 px-4 d-flex align-items-center justify-content-between">
    ...
    <div class="d-flex align-items-center gap-3">
        ...
        <div class="d-none d-sm-flex align-items-center gap-2">
            <a href="{{ url('clear')}}" class="btn btn-link btn-sm text-decoration-none text-danger fw-medium px-2.5">
                <i class="fa-solid fa-trash-can me-1"></i> Clear Cache
            </a>
            <a href="{{ url('/')}}" target="_blank" class="btn btn-light btn-sm text-decoration-none text-dark fw-medium px-3 rounded-pill border border-slate-100">
        ...
        <div class="dropdown user">
            <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle gap-2 bg-light p-1.5 pe-3 rounded-pill"
                ...
                <img src="{{ asset('images/user.png') }}" alt="user image" width="28" height="28" class="rounded-circle object-fit-cover shadow-sm bg-white">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg mt-2 py-2 rounded-4" style="min-width: 200px; font-size: 0.875rem;" aria-labelledby="dropdownUser1">
                ...
                @can('user.profile')
                <li>
                    <a class="dropdown-item py-2 d-flex align-items-center gap-2 text-secondary" href="{{ route('user-profile') }}">
                ...
                @can('change.password')
                <li>
                    <a class="dropdown-item py-2 d-flex align-items-center gap-2 text-secondary" href="{{ route('change-password') }}">
                ...
                <li>
                    <form method="POST" action="{{ route('logout') }}" class="m-0">
                        @csrf
                        <a class="dropdown-item py-2 d-flex align-items-center gap-2 text-danger font-medium" href="{{ route('logout') }}"
