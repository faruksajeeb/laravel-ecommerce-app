                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{ asset('frontend-assets/imgs/shop/product-7-1.jpg') }}"
                                                    alt="">
                                                <img class="hover-img" src="{{ asset('frontend-assets/imgs/shop/product-7-2.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{ asset('frontend-assets/imgs/shop/product-1-2.jpg') }}"
                                                    alt="">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{ asset('frontend-assets/imgs/shop/product-5-2.jpg') }}"
                                                    alt="">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{ asset('frontend-assets/imgs/shop/product-8-2.jpg') }}"
                                                    alt="">
                                                <img class="hover-img" src="{{ asset('frontend-assets/imgs/shop/product-8-1.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{ asset('frontend-assets/imgs/shop/product-11-1.jpg') }}"
                                                    alt="">
                                                <img class="hover-img" src="{{ asset('frontend-assets/imgs/shop/product-11-2.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{ asset('frontend-assets/imgs/shop/product-13-1.jpg') }}"
                                                    alt="">
                                                <img class="hover-img" src="{{ asset('frontend-assets/imgs/shop/product-13-2.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{ asset('frontend-assets/imgs/shop/product-7-2.jpg') }}"
                                                    alt="">
                                                <img class="hover-img" src="{{ asset('frontend-assets/imgs/shop/product-7-1.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
