<div wire:ignore.self class="modal fade" id="addModal" tabindex="-1" aria-labelledby="brandModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-header bg-white border-bottom-0">
                <div class="d-flex align-items-center">
                    <div class="bg-primary bg-opacity-10 p-2 rounded-3 me-3">
                        <i class="fa-solid fa-tag text-primary fs-4"></i>
                    </div>
                    <div>
                        <h5 class="modal-title fw-bold" id="brandModalLabel">Create New Brand</h5>
                        <p class="text-muted small mb-0">Add a new product brand to your catalogue.</p>
                    </div>
                </div>
                ...
                <div class="modal-body px-4 pb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="custom-file-upload mb-2"
                            ...
                            <p class="mb-0 small">Click to upload brand logo</p>
                            <input type="file" id="brandLogo" wire:model="logo" class="d-none">
                        </div>
                        @error('logo')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                        @if ($logo)
                            <div class="preview-card shadow-sm mt-2"><img src="{{ $logo->temporaryUrl() }}"></div>
                        @endif
                    </div>
                </div>
