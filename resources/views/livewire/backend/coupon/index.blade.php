    ...
    <section>
        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body py-1">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                Current Page {{ $coupons->currentPage() }}
                            </div>
                        </div>
                                        ...
                                        <td>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input active_inactive_btn "
                                                    ...
                                                    table="coupons" type="checkbox" id="row_{{ $val->id }}"
                            ...
                            <div class="col-md-6 text-end">
                                <div>
                                    <p class="text-sm text-gray-700 leading-5">
                                        {!! __('Showing') !!}
                                        <span class="font-medium">{{ $coupons->firstItem() }}</span>
                                        {!! __('to') !!}
                                        <span class="font-medium">{{ $coupons->lastItem() }}</span>
                                        {!! __('of') !!}
                ...
                @include('livewire.backend.coupon.create')
                @include('livewire.backend.coupon.edit')
            </div>
        </div>
    </section>
</div>
