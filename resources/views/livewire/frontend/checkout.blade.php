                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" required="" name="lname" wire:model='last_name'
                                class='dorm-control @error('last_name') is-invalid  @enderror'
                        ...
                        <div class="form-group">
                            <input type="text" name="billing_address" wire:model='line1' placeholder="Address *"
                                class="@error('line1') is-invalid  @enderror">
                            @error('line1')
                                <div class="invalid-feedback error_msg">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                <div id="collapseAddress" class="different_address  in">
                                    <div class="form-group">
                                        <input type="text" required="" name="s_first_name"
                                            ...
                                            class=" @error('s_first_name') is-invalid  @enderror">
                                        @error('s_first_name')
                                            <div class="invalid-feedback error_msg">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        <input type="text" required="" name="s_last_name"
                                            ...
                                            class=" @error('s_last_name') is-invalid  @enderror">
                                        @error('s_last_name')
                                            <div class="invalid-feedback error_msg">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        <input required="" type="text" name="s_mobile" wire:model='s_mobile'
                                            placeholder="Mobile" class=" @error('s_mobile') is-invalid  @enderror">
                                        @error('s_mobile')
                                            <div class="invalid-feedback error_msg">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="payment_method">
                                ...
                                <div class="">
                                    <div class="custome-radio">
                                        <input class="form-check-input @error('payment_mode') is-invalid  @enderror"
                                ...
                                @if ($payment_mode == 'card')
                                    <div class="card-section">
                                        <div class="form-group">
                                            <input type="text"
                                                class="form-control @error('card_number') is-invalid                                   
                                        @enderror"
                                        ...
                                        <div class="form-group">
                                            <input type="text"
                                                class="form-control @error('expiry_month') is-invalid                                   
                                        @enderror"
                                        ...
                                        <div class="form-group">
                                            <input type="text"
                                                class="form-control @error('expiry_year') is-invalid                                   
                                        @enderror"
                                        ...
                                        <div class="form-group">
                                            <input type="password"
                                                class="form-control @error('cvc') is-invalid                                   
                                        @enderror"
