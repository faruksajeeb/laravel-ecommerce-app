                                ...
                                <div class="col-xl-4 col-lg-5">
                                    <div class="p-4 bg-light rounded-3 border border-light-subtle h-100">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" value="{{ old('name') }}" class="form-control shadow-sm" placeholder="Enter full name" required>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label fw-semibold small text-muted">User Email <span class="text-danger">*</span></label>
                                            <input type="email" name="email" value="{{ old('email') }}" class="form-control shadow-sm" placeholder="user@example.com" required>
                                        </div>
