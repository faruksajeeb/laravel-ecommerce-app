                        ...
                        <div class="card border-0 shadow-sm rounded-4 p-4 p-sm-5 bg-white mb-4">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="fw-semibold text-dark py-2 px-3 bg-light rounded-3">{{ auth()->user()->name }}</div>
                                </div>
                                
                                <div class="col-md-6">
                                    <label class="form-label text-muted small fw-medium mb-1">Email Address</label>
                                    <div class="fw-semibold text-dark py-2 px-3 bg-light rounded-3">{{ auth()->user()->email }}</div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="fw-semibold text-dark py-2 px-3 bg-light rounded-3">
                                        {{ auth()->user()->created_at?->format('F d, Y') ?? 'N/A' }}
                                    </div>
                                </div>
